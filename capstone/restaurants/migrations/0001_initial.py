    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.TextField(blank=True, max_length=64)),
                ('state', models.CharField(max_length=64)),
                ('country', django_countries.fields.CountryField(max_length=2)),
                ('description', models.TextField(default='', max_length=200)),
                ('courses', models.ManyToManyField(blank=True, related_name='kitchen_courses', to='restaurants.menu_course')),
                ('cuisine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cuisines', to='restaurants.cuisine_categories')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='restaurants.menu_course')),
